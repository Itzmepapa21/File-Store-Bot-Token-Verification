...
DB_NAME = os.environ.get("DATABASE_NAME", "Clusterq")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002014464845"))
FORCE_SUB_CHANNEL_2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002183703601"))
