...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7201127119:AAEqWsQ8mieKwS-9eD6lqgFyPKKNSnXhpF0")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7285888015 5604835136 6907639205").split()):
        ADMINS.append(int(x))
except ValueError:
